...
const personalLearningImg = "/assets/projects/personalLearningImg.png";
const bloodConnectImg = "/assets/projects/bloodConnectImg.png";
const yojanaAiImg = "/assets/projects/yojanaAiImg.png";
...
const projectsData = [
  ...
  {
    image: yojanaAiImg,
    category: "GovTech & Civic AI",
    title: "YojanaAI",
    description:
      "An AI-powered Indian government scheme assistant that helps citizens discover, compare, and understand welfare schemes in their own language. The platform combines multilingual chat, voice input, speech-to-text, text-to-speech, life-event-based recommendations, eligibility matching, scheme browsing, comparison tools, and document checking. It works with a live database of 219+ schemes and uses both rule-based and ML-assisted matching to surface relevant benefits faster. Built with Next.js, TypeScript, and Tailwind CSS, it also includes WhatsApp support for simple, low-friction access to scheme information.",
    tags: [
      "Next.js",
      "React",
      "TypeScript",
    ...
    href: "https://github.com/TanmayWarthe/yojana_ai-",
    demoUrl: "https://yojana-ai-livid.vercel.app/",
  },
  // {
