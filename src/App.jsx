  ...
  return (
    <div className="bg-[#0F172A] text-[#E2E8F0] min-h-screen flex flex-col">
      ...
      <main className="flex-1 relative bg-tech-gradient tech-grid">
        ...
        <section id="certificates" className="py-6 sm:py-8 lg:py-10">
          <Suspense fallback={<div className="max-w-6xl mx-auto px-4 sm:px-6"><div className="h-40 animate-pulse rounded-2xl bg-[#0B1220] border border-[#111827]" /></div>}>
            <Certificates />
          </Suspense>
        </section>
        ...
        {/* Skills Section */}
        <section id="skills" className="py-6 sm:py-8 lg:py-10">
          <Suspense fallback={<div className="max-w-6xl mx-auto px-4 sm:px-6"><div className="h-40 animate-pulse rounded-2xl bg-[#0B1220] border border-[#111827]" /></div>}>
            <Skills />
          </Suspense>
        </section>
        ...
        {/* Projects Section */}
        <section id="projects" className="py-6 sm:py-8 lg:py-10">
          <Suspense fallback={<div className="max-w-6xl mx-auto px-4 sm:px-6"><div className="h-40 animate-pulse rounded-2xl bg-[#0B1220] border border-[#111827]" /></div>}>
            <Projects />
          </Suspense>
        </section>
